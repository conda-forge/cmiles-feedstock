About cmiles-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cmiles-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10458&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cmiles-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cmiles, cmiles-base` can be installed with `conda`:
...
```
mamba install cmiles cmiles-base
```

It is possible to list all of the versions of `cmiles` available on your platform with `conda`:
...
```
mamba search cmiles --channel conda-forge
```
...
mamba repoquery search cmiles --channel conda-forge

# List packages depending on `cmiles`:
mamba repoquery whoneeds cmiles --channel conda-forge

# List dependencies of `cmiles`:
mamba repoquery depends cmiles --channel conda-forge
```
